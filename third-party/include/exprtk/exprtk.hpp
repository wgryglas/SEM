...
namespace exprtk
{
   ...
   namespace details
   {
      ...
      public:
         ...
         enum node_type
         {
            ...
            e_vecelem      , e_break        , e_continue     , e_swap
         };
   ...
   private:
         ...
         if (!token_is(token_t::e_eof))
         {
            ...
            if (0 == (initialiser = parse_expression()))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR55 - Failed to parse initialiser of for-loop"));
               result = false;
            }
            ...
            if (!token_is(token_t::e_eof))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR56 - Expected ';' after initialiser of for-loop"));
               result = false;
            }
         }
         ...
         if (!token_is(token_t::e_eof))
         {
            if (0 == (condition = parse_expression()))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR57 - Failed to parse condition of for-loop"));
               result = false;
            }
            else if (!token_is(token_t::e_eof))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR58 - Expected ';' after condition section of for-loop"));
               result = false;
            }
         }
         ...
         if (!token_is(token_t::e_rbracket))
         {
            if (0 == (incrementor = parse_expression()))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR59 - Failed to parse incrementor of for-loop"));
               result = false;
            }
            else if (!token_is(token_t::e_rbracket))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR60 - Expected ')' after incrementor section of for-loop"));
               result = false;
            }
         }
         ...
         if (result)
         {
            ...
            if (0 == (loop_body = parse_multi_sequence("for-loop")))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR61 - Failed to parse body of for-loop"));
               result = false;
            }
         }
      ...
      inline expression_node_ptr parse_switch_statement()
      {
         ...
         if (!token_is(token_t::e_lcrlbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR63 - Expected '{' for call to switch statement"));
         ...
         for ( ; ; )
         {
            if (!details::imatch("case",current_token_.value))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR64 - Expected either a 'case' or 'default' statement"));
            ...
            else if (!token_is(token_t::e_colon))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR65 - Expected ':' for case of switch statement"));
            ...
            else if (!token_is(token_t::e_eof))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR66 - Expected ';' at end of case for switch statement"));
            ...
            if (details::imatch("default",current_token_.value))
            {
               ...
               if (!token_is(token_t::e_colon))
               {
                  set_error(
                     make_error(parser_error::e_syntax,
                                current_token_,
                                "ERR67 - Expected ':' for default of switch statement"));
               ...
               else if (!token_is(token_t::e_eof))
               {
                  set_error(
                     make_error(parser_error::e_syntax,
                                current_token_,
                                "ERR68 - Expected ';' at end of default for switch statement"));
         ...
         if (!token_is(token_t::e_rcrlbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR69 - Expected '}' at end of switch statement"));
      ...
      inline expression_node_ptr parse_multi_switch_statement()
      {
         ...
         if (!token_is(token_t::e_lcrlbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR71 - Expected '{' for call to [*] statement"));
         ...
         for ( ; ; )
         {
            if (!details::imatch("case",current_token_.value))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR72 - Expected a 'case' statement for multi-switch"));
            ...
            if (!token_is(token_t::e_colon))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR73 - Expected ':' for case of [*] statement"));
            ...
            if (!token_is(token_t::e_eof))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR74 - Expected ';' at end of case for [*] statement"));
         ...
         if (!token_is(token_t::e_rcrlbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR75 - Expected '}' at end of [*] statement"));
      ...
      inline expression_node_ptr parse_vararg_function()
      {
         ...
         else
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR76 - Unsupported vararg function: " + symbol));
         ...
         if (!token_is(token_t::e_lbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR77 - Expected '(' for call to vararg function: " + symbol));
         ...
         if (!token_is(token_t::e_lcrlbracket))
         {
            ...
            else
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR79 - Expected '" + token_t::to_str(close_bracket) + "' for call to multi-sequence" +
         ...
         for (;;)
         {
            ...
            if (!token_is(seperator) && is_next_close)
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR80 - Expected '" + details::to_str(seperator) + "' for call to multi-sequence section of " + source));
      ...
      inline bool parse_range(range_pack& rp)
      {
         ...
         if (!token_is(token_t::e_lsqrbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR81 - Expected '[' for start of range"));
         ...
         else
         {
            ...
            if (0 == r0)
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR82 - Failed parse begin section of range"));
            ...
            else if (is_constant_node(r0))
            {
               ...
               if (r0_value < T(0))
               {
                  set_error(
                     make_error(parser_error::e_syntax,
                                current_token_,
                                "ERR83 - Range lower bound less than zero! Constraint: r0 >= 0"));
            ...
            if (!token_is(token_t::e_colon))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR84 - Expected ':' for break  in range"));
         ...
         else
         {
            ...
            if (0 == r1)
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR85 - Failed parse end section of range"));
            ...
            else if (is_constant_node(r1))
            {
               ...
               if (r1_value < T(0))
               {
                  set_error(
                     make_error(parser_error::e_syntax,
                                current_token_,
                                "ERR86 - Range upper bound less than zero! Constraint: r1 >= 0"));
            ...
            if (!token_is(token_t::e_rsqrbracket))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR87 - Expected ']' for start of range"));
         ...
         if (rp.const_range())
         {
            ...
            if (!rp_result || (r0 > r1))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR88 - Invalid range, Constraint: r0 <= r1"));
         ...
         if (peek_token_is(token_t::e_lsqrbracket))
         {
               ...
               )
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR90 - Overflow in range for string: '" + const_str + "'[" +
      ...
      inline expression_node_ptr parse_vector()
      {
         ...
         if (0 == (vec = symbol_table_.get_vector(symbol)))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR91 - Symbol '" + symbol+ " not a vector"));
         ...
         if (!token_is(token_t::e_lsqrbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR92 - Expected '[' for index of vector: '" + symbol + "'"));
      ...
      inline expression_node_ptr parse_define_vector_statement(const std::string vec_name)
      {
         ...
         if (!exprtk::details::string_to_real(current_token_.value,vector_size))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR108 - Failed to parse vector size."));

            return error_node();
         }
         else if (
                   (vector_size <= T(0)) ||
                   ((vector_size - details::numeric::trunc(vector_size)) != 0)
                 )
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR109 - Invalid vector size. Must be an integer greater than zero, size: " + details::to_str((int)vector_size)));
         ...
         if (!token_is(token_t::e_rsqrbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR110 - Expected ']' as part of vector size definition"));
         ...
         else if (!token_is(token_t::e_assign))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR111 - Expected ':=' as part of vector definition"));
         ...
         else if (!token_is(token_t::e_eof))
         {
            if (!token_is(token_t::e_lsqrbracket))
            {
               ...
               if (0 == initialiser)
               {
                  set_error(
                     make_error(parser_error::e_syntax,
                                current_token_,
                                "ERR112 - Failed to parse single vector initialiser"));

                  return error_node();
               }

               for (std::size_t i = 0; i < static_cast<std::size_t>(vector_size); ++i)
               {
               ...
               if (!token_is(token_t::e_lsqrbracket))
               {
                  set_error(
                     make_error(parser_error::e_syntax,
                                current_token_,
                                "ERR113 - Expected ']' to close single value vector initialiszer"));
               ...
               for (;;)
               {
                  ...
                  if (0 == initialiser)
                  {
                     set_error(
                        make_error(parser_error::e_syntax,
                                   current_token_,
                                   "ERR115 - Expected '{' as part of vector initialiser list"));
                  ...
                  if (!token_is(token_t::e_comma) && is_next_close)
                  {
                     set_error(
                        make_error(parser_error::e_syntax,
                                   current_token_,
                                   "ERR116 - Expected ',' between vector initialisers"));
            ...
            if (!token_is(token_t::e_eof))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR117 - Expected ';' at end of vector definition"));

               return error_node();
            }
            else if (vec_initilizer_list.size() > vector_size)
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR118 - Initilizer list larger than the number of elements in the vector: '"+ vec_name +"'"));
      ...
      inline expression_node_ptr parse_define_var_statement()
      {
         ...
         else if (local_symbol_table_.symbol_exists(var_name))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
      ...
      inline expression_node_ptr parse_swap_statement()
      {
         ...
         if (!token_is(token_t::e_lbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                           current_token_,
                           "ERR126 - Expected '(' at start of swap statement"));
         ...
         if (!token_is(token_t::e_symbol,false))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR127 - Expected a symbol for variable or vector element definition"));
         ...
         else if (peek_token_is(token_t::e_lsqrbracket))
         {
            if (0 == (variable0 = parse_vector()))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR128 - First parameter to swap is an invalid vector element: '" + var0_name +"'"));
         ...
         else
         {
            ...
            else if (local_symbol_table_.is_variable(var0_name))
            {
               variable0 = local_symbol_table_.get_variable(var0_name);
            }
            ...
            if (0 == variable0)
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR129 - First parameter to swap is an invalid variable: '" + var0_name +"'"));
         ...
         if (!token_is(token_t::e_comma))
         {
            set_error(
                make_error(parser_error::e_syntax,
                           current_token(),
                           "ERR130 - Expected ',' between parameters to swap"));
         ...
         if (!token_is(token_t::e_symbol,false))
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR131 - Expected a symbol for variable or vector element definition"));
         ...
         else if (peek_token_is(token_t::e_lsqrbracket))
         {
            if (0 == (variable1 = parse_vector()))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR132 - Second parameter to swap is an invalid vector element: '" + var1_name +"'"));
         ...
         else
         {
            ...
            else if (local_symbol_table_.is_variable(var1_name))
            {
               variable1 = local_symbol_table_.get_variable(var1_name);
            }
            ...
            if (0 == variable1)
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR133 - Second parameter to swap is an invalid variable: '" + var1_name + "'"));
         ...
         if (!token_is(token_t::e_rbracket))
         {
            set_error(
               make_error(parser_error::e_syntax,
                           current_token_,
                           "ERR134 - Expected ')' at end of swap statement"));
      ...
      inline expression_node_ptr parse_symtab_symbol()
      {
         ...
         if (vararg_function)
         {
            ...
            else
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR135 - Failed to generate node for vararg function: '" + symbol + "'"));
         ...
         if (details::is_reserved_symbol(symbol))
         {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR136 - Invalid use of reserved symbol '" + symbol + "'"));
            ...
            if (unknown_symbol_resolver_->process(symbol,symbol_type,default_value,error_message))
            {
               ...
               set_error(
                  make_error(parser_error::e_symtab,
                             current_token_,
                             "ERR137 - Failed to create variable: '" + symbol + "'"));
         ...
         set_error(
            make_error(parser_error::e_syntax,
                       current_token_,
                       "ERR138 - Undefined variable or function: '" + symbol + "'"));
      ...
      inline expression_node_ptr parse_symbol()
      {
         ...
         else
         {
            set_error(
               make_error(parser_error::e_symtab,
                          current_token_,
                          "ERR139 - Variable or function detected, yet symbol-table is invalid, Symbol: " + current_token_.value));
      ...
      inline expression_node_ptr parse_branch(precedence_level precedence = e_level00)
      {
            ...
            else
            {
               set_error(
                  make_error(parser_error::e_numeric,
                             current_token_,
                             "ERR140 - Failed to convert '" + current_token_.value + "' to a number"));
         ...
         else if (token_t::e_lbracket == current_token_.type)
         {
            ...
            else if (!token_is(token_t::e_rbracket))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR141 - Expected ')' instead of: '" + current_token_.value + "'"));
         ...
         else if (token_t::e_lsqrbracket == current_token_.type)
         {
            ...
            else if (!token_is(token_t::e_rsqrbracket))
            {
               set_error(
                  make_error(parser_error::e_syntax,
                             current_token_,
                             "ERR142 - Expected ']' instead of: '" + current_token_.value + "'"));
         ...
         else if (token_t::e_eof == current_token_.type)
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR144 - Premature end of expression[1]"));
         ...
         else
         {
            set_error(
               make_error(parser_error::e_syntax,
                          current_token_,
                          "ERR145 - Premature end of expression[2]"));
